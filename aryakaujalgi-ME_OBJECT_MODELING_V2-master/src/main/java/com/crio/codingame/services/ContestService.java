...
public class ContestService implements IContestService {
    ...
    public Contest create(String contestName, Level level, String contestCreator, Integer numQuestion) throws UserNotFoundException, QuestionNotFoundException {
        final User user = userRepository.findByName(contestCreator).orElseThrow(() -> new UserNotFoundException("Contest Creator for given name: creator not found!"));
    ...
    @Override
    public ContestSummaryDto runContest(String contestId, String contestCreator) throws ContestNotFoundException,InvalidOperationException,InvalidContestException {
      ...
      /*  if(allContestUser.contains(contest.getCreator()))
        {
    ...
    private void validateContest(final Contest contest, final String contestCreator) throws InvalidContestException,InvalidOperationException {

        if(contestRepository.findAll().contains(contest))
        {
           throw new InvalidOperationException();
        }
